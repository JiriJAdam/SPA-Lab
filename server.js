...
app.post("/create_employee", function (req, res) {
	...
	var data = 
		...
		var config = {
			method: 'post',
			url: 'https://spa-project-d1bea-default-rtdb.firebaseio.com/data.json',
			headers: { 
...
app.get("/directory", function (req, res) {
	...
	var config = {
	method: 'get',
	url: 'https://spa-project-d1bea-default-rtdb.firebaseio.com/.json', 
	headers: { }
	};
...
app.get("/directory/:uid", function (req, res) {
 let id = req.params.uid;
	...
	var config = {
		method: 'get',
		url: `https://spa-project-d1bea-default-rtdb.firebaseio.com/data/${id}.json`,
		headers: { }
	  };
...
// https://spa-project-d1bea-default-rtdb.firebaseio.com/